Public Class frmPendaftar
    ...
    Private Sub frmPendaftar_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim des() As String = {"no", "nama", "jeniskelamin", "tempatlahir", "tanggallahir", "alamat", "agama", "namaayah", "namaibu", "pekerjaanayah", "pekerjaanibu"}
        Dim va() = {txtNo, txtNama, cmbJenis, txtTmpt, dtTanggal, cmbAgama, txtAlamat, txtAyah, txtIbu, txtPAyah, txtPIbu}

        Dim deslv() As String = {"Nomor Pendaftaran", "Nama Siswa", "Jenis Kelamin", "Tempat Lahir", "Tanggal Lahir", "Alamat", "Agama", "Nama Ayah", "Nama Ibu", "Pekerjaan Ayah", "Pekerjaan Ibu"}
