...
Public Class frmPenilaian
    ...
    Dim sql As String = "select no_pendaftar,nama,minatATPH,minatBUN,utpATPH,utpBUN,ukATPH,ukBUN,w1,w2,w3 from penilaian,pendaftar where penilaian.no_pendaftar=pendaftar.no"
    ...
    Private Sub frmPenilaian_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim des() As String = {"no_pendaftar", "minatATPH", "minatBUN", "utpATPH", "utpBUN", "ukATPH", "ukBUN", "w1", "w2", "w3"}
        Dim va() = {cmbNoDaftar, c1(c1a.Checked), c1(c1b.Checked), c2a, c2b, c3a, c3b, w1, w2, w3}

        Dim desLv() As String = {"No Pendaftar", "Nama Siswa", "Minat ATPH", "Minat BUN", "UTP ATPH", "UTP BUN", "UK ATPH", "UKBUN", "W1", "W2", "W3"}
